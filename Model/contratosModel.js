  ...
  try {
    ...
    const resContrato = await client.query(
      `INSERT INTO sistema.contratos 
       (id_cliente, id_terreno, fecha_firma, tipo_plan, precio_total, enganche, plazo, monto_mensual, estatus)
       VALUES ($1, $2, CURRENT_DATE, $3, $4, $5, $6, $7, 'activo') RETURNING *`,
      [id_cliente, id_terreno, tipo_plan, precio_total, enganche || 0, plazo || 0, monto_mensual || 0]
    );
